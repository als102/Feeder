...
var GetEventForText = /** @class */ (function (_super) {
    ...
    GetEventForText.prototype.compute = function (text, lang) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, params, response, requestId, _b, _c, i, res, e_1_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        params = { lang: lang, text: text, topClustersCount: this.nrOfEventsToReturn };
                        return [4 /*yield*/, this.er.jsonRequest("/api/v1/getEventForText/enqueueRequest", params)];
                    case 1:
                        response = _d.sent();
                    ...
                    case 2:
                        ...
                        _b = __values(_.range(10)), _c = _b.next();
                        _d.label = 3;
                    case 3:
                    ...
                    case 4:
                        _d.sent();
                        return [4 /*yield*/, this.er.jsonRequest("/api/v1/getEventForText/testRequest", { requestId: requestId })];
                    case 5:
                        res = _d.sent();
