...
var QueryArticles = /** @class */ (function (_super) {
    ...
    function QueryArticles(args) {
        ...
        _this.setVal("dataType", dataType);
...
var RequestArticlesSourceAggr = /** @class */ (function (_super) {
    ...
    function RequestArticlesSourceAggr(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.articlesSampleSize, articlesSampleSize = _b === void 0 ? 20000 : _b, _c = _a.sourceCount, sourceCount = _c === void 0 ? 50 : _c, _d = _a.normalizeBySourceArts, normalizeBySourceArts = _d === void 0 ? false : _d, _e = _a.returnInfo, returnInfo = _e === void 0 ? new returnInfo_1.ReturnInfo() : _e, unsupported = __rest(_a, ["articlesSampleSize", "sourceCount", "normalizeBySourceArts", "returnInfo"]);
        var _this = _super.call(this) || this;
...
var RequestArticlesRecentActivity = /** @class */ (function (_super) {
    ...
    function RequestArticlesRecentActivity(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.maxArticleCount, maxArticleCount = _b === void 0 ? 100 : _b, _c = _a.updatesAfterTm, updatesAfterTm = _c === void 0 ? undefined : _c, _d = _a.updatesAfterMinsAgo, updatesAfterMinsAgo = _d === void 0 ? undefined : _d, _e = _a.updatesUntilTm, updatesUntilTm = _e === void 0 ? undefined : _e, _f = _a.updatesUntilMinsAgo, updatesUntilMinsAgo = _f === void 0 ? undefined : _f, _g = _a.mandatorySourceLocation, mandatorySourceLocation = _g === void 0 ? false : _g, _h = _a.returnInfo, returnInfo = _h === void 0 ? undefined : _h, unsupported = __rest(_a, ["maxArticleCount", "updatesAfterTm", "updatesAfterMinsAgo", "updatesUntilTm", "updatesUntilMinsAgo", "mandatorySourceLocation", "returnInfo"]);
        var _this = _super.call(this) || this;
