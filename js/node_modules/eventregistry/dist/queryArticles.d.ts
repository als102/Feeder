...
export declare class RequestArticlesSourceAggr extends RequestArticles {
    resultType: string;
    params: any;
    constructor({ articlesSampleSize, sourceCount, normalizeBySourceArts, returnInfo, ...unsupported }?: {
        articlesSampleSize?: number;
        sourceCount?: number;
...
export declare class RequestArticlesRecentActivity extends RequestArticles {
    resultType: string;
    params: any;
    constructor({ maxArticleCount, updatesAfterTm, updatesAfterMinsAgo, updatesUntilTm, updatesUntilMinsAgo, mandatorySourceLocation, returnInfo, ...unsupported }?: {
