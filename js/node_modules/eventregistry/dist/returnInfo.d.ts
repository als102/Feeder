...
export declare abstract class ReturnInfoFlagsBase<T extends {}> {
    ...
    private data;
    setFlag(key: string, value: boolean, defaultValue?: boolean): void;
...
export declare class ReturnInfo {
    ...
    constructor({ articleInfo, eventInfo, sourceInfo, categoryInfo, conceptInfo, locationInfo, storyInfo, conceptClassInfo, conceptFolderInfo, ...unsupported }?: {
     ...
     */
    static loadFromFile(filename: string): ReturnInfo;
}
